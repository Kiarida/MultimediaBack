...
class __TwigTemplate_6edd331cbdd4d8e5762f5f6cb949761d5ecfc9a7550e86f62c2bad7ad2531e49 extends Twig_Template
{
    ...
    <div class=\"content\" style=\"display: ";
        ...
        echo "
            ";
        // line 130
        if (($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "response", array(), "any", true, true) && (!twig_test_empty($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "response", array()))))) {
            // line 131
            echo "                <h4>Return</h4>
                <table class='fullwidth'>
                    <thead>
            ...
            // line 142
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "response", array()));
            foreach ($context['_seq'] as $context["name"] => $context["infos"]) {
                // line 143
                echo "                            <tr>
                                <td>";
